...
export const es: Translations = {
  ...
  sessions: {
    ...
    checkpointingWarning: 'Los puntos de control pueden afectar la estructura del directorio o causar pérdida de datos. Usar con precaución.',
    automaticCheckpoints: 'Puntos de Control Automáticos',
    automaticCheckpointsDesc: 'Crear automáticamente puntos de control basados en la estrategia seleccionada',
  ...
  settings: {
    ...
    choosePreferredInstallation: 'Elige tu instalación preferida de Claude Code. Se recomienda la versión empaquetada para mejor compatibilidad.',
    ...
    multipleInstallationsFound: 'Se encontraron múltiples instalaciones de Claude Code en tu sistema. Por favor selecciona cuál te gustaría usar.',
    claudeNotFoundInLocations: 'Claude Code no se encontró en ninguna de las ubicaciones de instalación comunes. Por favor instala Claude Code para continuar.',
  ...
  mcp: {
    ...
    addServerToGetStarted: 'Agregar un servidor para comenzar con el Protocolo de Contexto de Modelo',
    ...
    importFromClaudeDesktopDesc: 'Importar automáticamente todos los servidores MCP desde Claude Desktop. Se instala en el ámbito de usuario (disponible en todos los proyectos).',
    ...
    useClaudeCodeAsMcpDesc: 'Iniciar Claude Code como un servidor MCP al que otras aplicaciones pueden conectarse',
    ...
    unrecognizedJsonFormat: 'Formato JSON no reconocido. Se esperaba configuración de servidor MCP.',
    failedToImportJson: 'Error al importar archivo JSON',
    exportFunctionalityComingSoon: '¡Funcionalidad de exportación próximamente!',
    claudeCodeMcpServerStarted: 'Servidor MCP de Claude Code iniciado. Ahora puedes conectarte desde otras aplicaciones.',
    ...
    // MCPManager相关
    failedToLoadServers: 'Error al cargar servidores MCP. Por favor asegúrate de que Claude Code esté instalado.',
  ...
  agents: {
    ...
    defaultTaskDesc: 'Esto se usará como marcador de posición de tarea predeterminada al ejecutar el agente',
    ...
    page: 'Página',
    of: 'de',
    deleteAgentConfirmation: '¿Estás seguro de que quieres eliminar el agente "{name}"? Esta acción no se puede deshacer y eliminará permanentemente el agente y todos sus datos asociados.',
    deleting: 'Eliminando...',
  },
  ...
  hooks: {
    ...
    subtitle: 'Configura comandos shell para ejecutar en varios puntos del ciclo de vida de Claude Code',
    scope: 'Ámbito',
    ...
    preToolUseDesc: 'Se ejecuta antes de las llamadas de herramientas, puede bloquear y proporcionar retroalimentación',
    ...
    patternTooltip: 'Patrón de nombre de herramienta (regex soportado). Dejar vacío para coincidir con todas las herramientas.',
  ...
  commands: {
    ...
    contentDesc: 'Usa $ARGUMENTS para entrada del usuario, @filename para archivos, y !`command` para comandos bash',
    ...
    deleteCommandDesc: 'Esta acción no se puede deshacer. El archivo del comando será eliminado permanentemente.',
    deleting: 'Eliminando...',
    scope: 'Ámbito',
  ...
  storage: {
    ...
    autoCleanupDesc: 'Eliminar automáticamente datos antiguos más antiguos que los días especificados',
    ...
    deleteRowConfirm: '¿Está seguro de que desea eliminar esta fila? Esta acción no se puede deshacer.',
    delete: 'Eliminar',
    resetDatabase: 'Restablecer Base de Datos',
    resetDatabaseDesc: 'Esto eliminará todos los datos y recreará la base de datos con su estructura predeterminada (tablas vacías para agents, agent_runs y app_settings). La base de datos se restaurará al mismo estado que cuando instaló la aplicación por primera vez. Esta acción no se puede deshacer.',
    resetWarning: '¡Todos sus agentes, ejecuciones y configuraciones se eliminarán permanentemente!',
    sqlQueryEditor: 'Editor de Consultas SQL',
    sqlQueryEditorDesc: 'Ejecutar consultas SQL sin procesar en la base de datos. Usar con precaución.',
    ...
    databaseResetComplete: 'Restablecimiento de Base de Datos Completo: La base de datos ha sido restaurada a su estado predeterminado con tablas vacías (agents, agent_runs, app_settings).',
    resetFailed: 'Restablecimiento Fallido: Error al restablecer la base de datos. Por favor, inténtelo de nuevo.',
    nullValue: 'NULO',
    trueValue: 'verdadero',
    falseValue: 'falso',
  },
