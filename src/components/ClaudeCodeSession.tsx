...
// Import Tauri event API directly (works in both Vite ESM and Tauri builds)
import { listen as tauriListenImport } from "@tauri-apps/api/event";
type UnlistenFn = () => void;

// Use the direct import; it will work in Tauri builds and throw at runtime in pure web
const listen = tauriListenImport;
