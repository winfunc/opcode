...
export const CreateAgent: React.FC<CreateAgentProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(isEditMode ? t("agents.failedUpdate") : t("agents.failedCreate"));
      setToast({
        message: isEditMode ? t("agents.failedUpdate") : t("agents.failedCreate"),
        type: "error"
      });
    } finally {
      setSaving(false);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-body-small text-muted-foreground">
                  {isEditMode ? t("agents.editAgentDesc") : t("agents.createAgentDesc")}
                </p>
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-caption text-muted-foreground">{t("agents.sonnetDesc")}</div>
                      </div>
                    </div>
                  </motion.button>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-caption text-muted-foreground">{t("agents.opusDesc")}</div>
                      </div>
                    </div>
                  </motion.button>
                </div>
