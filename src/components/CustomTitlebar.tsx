    ...
    >
      ...
      <div className="flex items-center pr-5 gap-3 tauri-no-drag">
        ...
        <div className="flex items-center gap-1">
          ...
          {onUsageClick && (
            <TooltipSimple content={t('navigation.usageDashboard')} side="bottom">
              <motion.button
        ...
        <div className="flex items-center gap-1">
          {onSettingsClick && (
            <TooltipSimple content={t('navigation.settings')} side="bottom">
              <motion.button
          ...
          <div className="relative" ref={dropdownRef}>
            <TooltipSimple content={t('navigation.moreOptions')} side="bottom">
              <motion.button
              ...
              <div className="absolute right-0 mt-2 w-48 bg-popover border border-border rounded-lg shadow-lg z-[250]">
                <div className="py-1">
                  {onClaudeClick && (
                    ...
                    >
                      <FileText size={14} />
                      <span>{t('navigation.claudemd')}</span>
                    </button>
                  )}
                  ...
                  {onMCPClick && (
                    ...
                    >
                      <Network size={14} />
                      <span>{t('navigation.mcpServers')}</span>
                    </button>
                  )}
