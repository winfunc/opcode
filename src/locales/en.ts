...
export const en: Translations = {
  ...
  settings: {
    ...
    choosePreferredInstallation: 'Choose your preferred Claude Code installation. Bundled version is recommended for best compatibility.',
    ...
    claudeNotFoundInLocations: 'Claude Code was not found in any of the common installation locations. Please install Claude Code to continue.',
  ...
  mcp: {
    ...
    importFromClaudeDesktopDesc: 'Automatically import all MCP servers from Claude Desktop. Installs to user scope (available in all projects).',
    importing: 'Importing...',
    ...
    claudeCodeMcpServerStarted: 'Claude Code MCP server started. You can now connect to it from other applications.',
