          ...
          <div className="flex items-center space-x-2">
            ...
            >
              {isHovered && (
                <X
                  size={8}
                  className="text-red-900 opacity-60 group-hover:opacity-100"
                />
              )}
            </button>
            ...
            >
              {isHovered && (
                <Minus
                  size={8}
                  className="text-yellow-900 opacity-60 group-hover:opacity-100"
                />
              )}
            </button>
            ...
            >
              {isHovered && (
                <Square
                  size={6}
                  className="text-green-900 opacity-60 group-hover:opacity-100"
                />
              )}
            </button>
          </div>
