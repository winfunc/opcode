          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            >
              ...
              <TabsContent value="environment" className="space-y-6">
                <Card className="p-6">
                  <div className="space-y-6">
                    {/* Header with title and active group indicator */}
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Configure multiple environment variable groups for
                          different scenarios
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-1 rounded-md bg-green-500/10 text-green-600 dark:text-green-400 text-xs font-medium">
                    ...
                    <div className="flex items-center gap-2 p-1 bg-muted/30 rounded-lg overflow-x-auto">
                      {Object.entries(envGroups).map(([groupId, group]) => (
                        <div key={groupId} className="flex items-center">
                          ...
                          {/* Edit and Delete buttons for current edit group */}
                          {currentEditGroupId === groupId &&
                            groupId !== "default" && (
                    ...
                    {currentEditGroupId !== activeEnvGroupId && (
                      <div className="flex items-center gap-2">
                        ...
                        >
                          <Check className="h-3 w-3" />
                          Set "{envGroups[currentEditGroupId]?.name}" as Active
                        </Button>
                        <span className="text-xs text-muted-foreground">
                          Active group's variables will be applied to Claude
                          sessions
                        </span>
                      </div>
                    )}
