...
export class ResourceMonitor {
    ...
    try {
      ...
      const isHighUsage =
        ...
        (metrics.cpu_usage_percent &&
          metrics.cpu_usage_percent > this.highUsageThresholds.cpu) ||
        metrics.network_requests_count >
          this.highUsageThresholds.networkRequests;
   ...
   */
  setThresholds(
    thresholds: Partial<typeof ResourceMonitor.prototype.highUsageThresholds>,
  ): void {
