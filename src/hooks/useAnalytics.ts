...
export function useAnalytics(): UseAnalyticsReturn {
  ...
  const track = useCallback(
    (eventName: EventName | string, properties?: Record<string, any>) => {
...
export function useTrackEvent() {
  return {
    ...
    sessionResumed: (checkpointId: string) => {
      const event = eventBuilders.session({
        resumed: true,
    ...
    agentExecuted: (
      ...
      const event = eventBuilders.agent(
        agentType,
        success,
        agentName,
        durationMs,
    ...
    mcpServerDisconnected: (serverName: string) => {
      analytics.track(ANALYTICS_EVENTS.MCP_SERVER_DISCONNECTED, {
    ...
    promptSubmitted: (
      props: Parameters<typeof eventBuilders.promptSubmitted>[0],
    ) => {
    ...
    sessionStopped: (
      props: Parameters<typeof eventBuilders.sessionStopped>[0],
    ) => {
      const event = eventBuilders.sessionStopped(props);
      analytics.track(event.event, event.properties);
    },

    enhancedSessionStopped: (
      props: Parameters<typeof eventBuilders.enhancedSessionStopped>[0],
    ) => {
    ...
    checkpointCreated: (
      props: Parameters<typeof eventBuilders.checkpointCreated>[0],
    ) => {
    ...
    checkpointRestored: (
      props: Parameters<typeof eventBuilders.checkpointRestored>[0],
    ) => {
    ...
    agentProgress: (
      props: Parameters<typeof eventBuilders.agentProgress>[0],
    ) => {
    ...
    // MCP events
    mcpServerAdded: (
      props: Parameters<typeof eventBuilders.mcpServerAdded>[0],
    ) => {
    ...
    mcpServerRemoved: (
      props: Parameters<typeof eventBuilders.mcpServerRemoved>[0],
    ) => {
    ...
    mcpToolInvoked: (
      props: Parameters<typeof eventBuilders.mcpToolInvoked>[0],
    ) => {
    ...
    mcpConnectionError: (
      props: Parameters<typeof eventBuilders.mcpConnectionError>[0],
    ) => {
    ...
    slashCommandSelected: (
      props: Parameters<typeof eventBuilders.slashCommandSelected>[0],
    ) => {
    ...
    slashCommandExecuted: (
      props: Parameters<typeof eventBuilders.slashCommandExecuted>[0],
    ) => {
    ...
    slashCommandCreated: (
      props: Parameters<typeof eventBuilders.slashCommandCreated>[0],
    ) => {
    ...
    performanceBottleneck: (
      props: Parameters<typeof eventBuilders.performanceBottleneck>[0],
    ) => {
    ...
    memoryWarning: (
      props: Parameters<typeof eventBuilders.memoryWarning>[0],
    ) => {
    ...
    // User journey events
    journeyMilestone: (
      props: Parameters<typeof eventBuilders.journeyMilestone>[0],
    ) => {
    ...
    enhancedToolExecuted: (
      props: Parameters<typeof eventBuilders.enhancedToolExecuted>[0],
    ) => {
    ...
    enhancedError: (
      props: Parameters<typeof eventBuilders.enhancedError>[0],
    ) => {
    ...
    // Session engagement
    sessionEngagement: (
      props: Parameters<typeof eventBuilders.sessionEngagement>[0],
    ) => {
    ...
    featureDiscovered: (
      props: Parameters<typeof eventBuilders.featureDiscovered>[0],
    ) => {
    ...
    featureAdopted: (
      props: Parameters<typeof eventBuilders.featureAdopted>[0],
    ) => {
    ...
    featureCombination: (
      props: Parameters<typeof eventBuilders.featureCombination>[0],
    ) => {
    ...
    // Quality metrics
    outputRegenerated: (
      props: Parameters<typeof eventBuilders.outputRegenerated>[0],
    ) => {
    ...
    suggestionAccepted: (
      props: Parameters<typeof eventBuilders.suggestionAccepted>[0],
    ) => {
    ...
    suggestionRejected: (
      props: Parameters<typeof eventBuilders.suggestionRejected>[0],
    ) => {
    ...
    // AI interactions
    aiInteraction: (
      props: Parameters<typeof eventBuilders.aiInteraction>[0],
    ) => {
    ...
    promptPattern: (
      props: Parameters<typeof eventBuilders.promptPattern>[0],
    ) => {
    ...
    // Workflow tracking
    workflowStarted: (
      props: Parameters<typeof eventBuilders.workflowStarted>[0],
    ) => {
    ...
    workflowCompleted: (
      props: Parameters<typeof eventBuilders.workflowCompleted>[0],
    ) => {
    ...
    workflowAbandoned: (
      props: Parameters<typeof eventBuilders.workflowAbandoned>[0],
    ) => {
    ...
    // Network performance
    networkPerformance: (
      props: Parameters<typeof eventBuilders.networkPerformance>[0],
    ) => {
    ...
    networkFailure: (
      props: Parameters<typeof eventBuilders.networkFailure>[0],
    ) => {
    ...
    resourceUsageHigh: (
      props: Parameters<typeof eventBuilders.resourceUsageHigh>[0],
    ) => {
      const event = eventBuilders.resourceUsageHigh(props);
      analytics.track(event.event, event.properties);
    },

    resourceUsageSampled: (
      props: Parameters<typeof eventBuilders.resourceUsageSampled>[0],
    ) => {
  ...
  const trackUsage = useCallback(() => {
    ...
    if (usageCount.current === 5) {
      const daysSinceFirst =
        (Date.now() - startTime.current) / (1000 * 60 * 60 * 24);
